...
def tax_add(dataset):
    ...
    tax_columns = tax_data.columns[1:6]
    # IMPUTATION TIME
...
def main():
    ...
    full_dataset = full_dataset.drop('consumer_id', 'name', 'address', 'sa3name',	'sa4name',	'electoraterating',	'SA3_NAME_2016', 'electorate')
    full_dataset.write.parquet('../data/curated/full_dataset_Variation', mode='overwrite')
